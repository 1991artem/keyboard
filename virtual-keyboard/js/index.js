    ...
    const LG_LOW_WORD_ARRAY = ['§','1','2','3','4','5','6','7','8','9','0','-','=','Backspace','Tab','й','ц','у','к','е','н','г','i','щ','з','[',']',"BY",'CapsLock','ф','ы','в','а','п','р','о','л','д',';','\'','\\','Enter','Shift','`','я','ч','с','м','и','т','ь',',','.','/','ArrowUp','Shift','Control','Alt','Meta','Space','Meta','Alt','ArrowLeft','ArrowDown','ArrowRight'];
